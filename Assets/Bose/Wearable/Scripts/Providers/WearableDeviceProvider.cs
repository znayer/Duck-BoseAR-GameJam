...
namespace Bose.Wearable
{
	...
	internal sealed partial class WearableDeviceProvider : WearableProviderBase
	{
		...
		protected override void SetActiveNoiseReductionModeInternal(ActiveNoiseReductionMode mode)
		{
			...
			_nextProductControlQueryTime += WearableConstants.DeviceConnectUpdateIntervalInSeconds;
		...
		internal override DynamicDeviceInfo GetDynamicDeviceInfo()
		{
			if (Time.unscaledTime > _nextDynamicDeviceInfoTime)
			{
				...
				_nextDynamicDeviceInfoTime += WearableConstants.DeviceProviderDynamicInfoUpdateIntervalInSeconds;
			}
