...
namespace Bose.Wearable
{
	public static class WearableConstants
	{
		...
		public static readonly ActiveNoiseReductionMode[] ActiveNoiseReductionModes;
		public static readonly ActiveNoiseReductionMode[] EmptyActiveNoiseReductionModes;
		public static readonly DeviceStatusFlags[] DeviceStatusFlags;
		...
		public const float DeviceProviderDynamicInfoUpdateIntervalInSeconds = 2.5f;
		...
		public const string ProxyProviderRemovedWarning =
			"[Bose Wearable] The Proxy Provider's functionality has been removed. Your " +
			"project has automatically been updated to reflect this.";

		public const string ProxyProviderObsolete =
			"The Proxy Provider has been removed. This value remains to facilitate upgrading current projects and " +
			"will be removed from the API in an upcoming release.";

		public const string ProxyProviderCreateWarning =
			"[Bose Wearable] The Proxy Provider's functionality has been removed. A Debug " +
			"Provider has been returned instead of a Proxy Provider.";
		...
		public const string InvalidAutoReconnectTimeoutPeriodWarning =
			"[Bose Wearable] An auto-reconnect attempt was made with an invalid timeout period of [{0}], " +
			"this value should be positive.";

		public const string InvalidIsInvalidAnrMode = "[Bose Wearable] Invalid is not a valid ANR mode.";

		public const string AnrCncWriteLockError =
		...
		public const ActiveNoiseReductionMode DebugProviderDefaultAnrMode = ActiveNoiseReductionMode.Off;
		public static readonly ActiveNoiseReductionMode[] DebugProviderDefaultAvailableAnrModes;
		public const int DebugProviderDefaultCncLevel = 0;
		public const int DebugProviderDefaultTotalCncLevels = 11;
		public const bool DebugProviderDefaultCncEnabled = true;
		...
		public const string DebugProviderSetCncLevelFormat = "[Bose Wearable] Debug provider setting CNC level to {0}/{1} ({2}).";
		public const string DebugProviderSetAnrModeFormat = "[Bose Wearable] Debug Provider setting ANR mode to {0}.";
		public const string DebugProviderSetInvalidAnrModeWarning =
			"[Bose Wearable] Debug Provider cannot set ANR mode to {0}, as it is not in the set of available modes.";
		public const string DebugProviderAnrInfoRequested =
			"[Bose Wearable] Debug provider received a request for active noise reduction information.";
		public const string DebugProviderCncInfoRequested =
			"[Bose Wearable] Debug provider received a request for controllable noise cancellation information.";
		public const string DebugProviderCncNotEnabledWarning =
		...
		public const string DebugProviderAnrNotEnabledWarning =
		...
		public const string USBProviderNoCNCWarning = "[Bose Wearable] The Controllable Noise Cancellation feature is not available on the connected device.";
		public const string USBProviderANRNotAvailableWarning = "[Bose Wearable] The USB provider does not support Active Noise Reduction.";
		...
		public const string WaitForCalibrationMessage = "Please look forward \nand remain still...";
		...
		static WearableConstants()
		{
			...
			ActiveNoiseReductionModes = (ActiveNoiseReductionMode[]) Enum.GetValues(typeof(ActiveNoiseReductionMode));
			EmptyActiveNoiseReductionModes = new ActiveNoiseReductionMode[0];
			DeviceStatusFlags = (DeviceStatusFlags[]) Enum.GetValues(typeof(DeviceStatusFlags));
			...
			DisallowedEditorProviders = new[]{ ProviderId.MobileProvider, ProviderId.WearableDevice, ProviderId.WearableProxy};
			DisallowedRuntimeProviders = new[]{ ProviderId.MobileProvider, ProviderId.USBProvider, ProviderId.WearableProxy };
			#pragma warning restore 618

			DebugProviderDefaultAvailableAnrModes = new[] {
			...
			EmptyDynamicDeviceInfo = new DynamicDeviceInfo
			{
				...
				availableActiveNoiseReductionModes = WearableTools.GetActiveNoiseReductionModesAsInt(EmptyActiveNoiseReductionModes),
